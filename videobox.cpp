...
void VideoBox::change_video_6(const QList<int> &indexs)
{
    ...
    hide_video_all();
    //挨个重新添加到布局
//    gridLayout->addWidget(widgets.at(indexs.at(0)), 0, 0, 1, 2);
...
//    gridLayout->addWidget(widgets.at(indexs.at(4)), 2, 1, 1, 1);
    ...
    gridLayout->addWidget(widgets.at(indexs.at(4)), 1, 0, 1, 4);
 ...
 // widgets.at(5)->->setPixmap(QPixmap(":/bg_novideo.png"));
    //gridLayout.at(indexs.at(2))->
    widgets.at(5)->setVisible(false);
}
...
void VideoBox::change_video_9(int index)
{
    ...
    gridLayout->addWidget(widgets.at(indexs.at(3)), 0, 3, 1, 1);
    gridLayout->addWidget(widgets.at(indexs.at(4)), 1, 0, 1, 1);
    gridLayout->addWidget(widgets.at(indexs.at(5)), 1, 1, 1, 1);
    gridLayout->addWidget(widgets.at(indexs.at(6)), 1, 2, 1, 1);
    gridLayout->addWidget(widgets.at(indexs.at(7)), 1, 3, 1, 1);
    gridLayout->addWidget(widgets.at(indexs.at(8)), 2, 0, 1, 4);
